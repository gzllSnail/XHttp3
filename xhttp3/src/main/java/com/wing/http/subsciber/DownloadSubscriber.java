...
package com.wing.http.subsciber;

import static com.wing.http.exception.ApiException.ERROR.DOWNLOAD_ERROR;
...
import com.wing.http.callback.DownloadProgressCallBack;
import com.wing.http.exception.ApiException;
import com.wing.http.logs.HttpLog;
import com.wing.http.utils.PathUtils;
