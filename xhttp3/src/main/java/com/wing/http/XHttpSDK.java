...
import static com.wing.http.XHttp.DEFAULT_RETRY_COUNT;
import static com.wing.http.XHttp.DEFAULT_RETRY_DELAY;
import static com.wing.http.XHttp.DEFAULT_TIMEOUT_MILLISECONDS;
...
import com.wing.http.annotation.NetMethod;
import com.wing.http.annotation.RequestParams;
import com.wing.http.annotation.ThreadType;
import com.wing.http.cache.RxCache;
import com.wing.http.cache.converter.GsonDiskConverter;
import com.wing.http.cache.key.ICacheKeyCreator;
import com.wing.http.cache.key.IObjectSerializer;
import com.wing.http.cache.key.Strings;
import com.wing.http.cache.model.CacheMode;
import com.wing.http.interceptor.HttpLoggingInterceptor;
import com.wing.http.logs.HttpLog;
import com.wing.http.model.XHttpRequest;
import com.wing.http.request.PostRequest;
import com.wing.http.subsciber.BaseSubscriber;
import com.wing.http.utils.ApiUtils;
import com.wing.http.utils.HttpUtils;
