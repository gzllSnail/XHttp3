...
import static com.wing.http.XHttp.DEFAULT_CACHE_NEVER_EXPIRE;
...
import com.wing.http.annotation.ThreadType;
import com.wing.http.api.ApiService;
import com.wing.http.cache.RxCache;
import com.wing.http.cache.converter.IDiskConverter;
...
import com.wing.http.callback.CallClazzProxy;
import com.wing.http.https.HttpsUtils;
import com.wing.http.interceptor.BaseDynamicInterceptor;
import com.wing.http.interceptor.CacheInterceptor;
import com.wing.http.interceptor.CacheInterceptorOffline;
import com.wing.http.interceptor.HeadersInterceptor;
import com.wing.http.interceptor.NoCacheInterceptor;
import com.wing.http.model.ApiResult;
import com.wing.http.model.HttpHeaders;
import com.wing.http.model.HttpParams;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    protected R build() {
        ...
        retrofitBuilder.addCallAdapterFactory(RxJava3CallAdapterFactory.create());//增加RxJavaCallAdapterFactory
